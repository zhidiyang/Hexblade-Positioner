...
pointNozzleHolderWithFlexureBottom, pointNozzleHolderWithFlexureTop] = Right_Prism_Properties_Without_Inertia(pointNozzleHolderWithFlexureBottom(1,:), pointNozzleHolderWithFlexureBottom(2,:), W, rho);
...
pointNozzleHolderCutBottom, pointNozzleHolderCutTop] = Right_Prism_Properties_Without_Inertia(pointNozzleHolderCutBottom(1,:), pointNozzleHolderCutBottom(2,:), W-tabThickness, rho);
...
for tempCount = [1:1:polyNumNozzleHolderSubtract]
	...
	pointNozzleHolderSubtractBottom{tempCount}, pointNozzleHolderSubtractTop{tempCount}] = Right_Prism_Properties_Without_Inertia(polyNozzleHolderSubtract(tempCount).Vertices(:,1)', polyNozzleHolderSubtract(tempCount).Vertices(:,2)', W, rho);
end
...
pointNozzleHolderCutRemainBottom, pointNozzleHolderCutRemainTop] = Right_Prism_Properties_Without_Inertia(pointNozzleHolderCutBottom(1,:), pointNozzleHolderCutBottom(2,:), tabThickness, rho);
...
pointNozzleHolderBottom, pointNozzleHolderTop] = Right_Prism_Properties_Without_Inertia(pointNozzleHolderBottom(1,:), pointNozzleHolderBottom(2,:), W, rho);
...
for tempCount = [1:1:polyNumNozzleHolderSubtractNoFlexure]
	...
	pointNozzleHolderSubtractNoFlexureBottom{tempCount}, pointNozzleHolderSubtractNoFlexureTop{tempCount}] = Right_Prism_Properties_Without_Inertia(polyNozzleHolderSubtractNoFlexure(tempCount).Vertices(:,1)', polyNozzleHolderSubtractNoFlexure(tempCount).Vertices(:,2)', W, rho);
end
...
pointBladeVAHBottom_3, pointBladeVAHTop_3] = Right_Prism_Properties_Without_Inertia(pointBladeVAHBottom_3(1,:), pointBladeVAHBottom_3(2,:), W, rho);
...
pointBottomBladeBottom_1, pointBottomBladeTop_1] = Right_Prism_Properties_Without_Inertia(pointBottomBladeBottom_1(1,:), pointBottomBladeBottom_1(2,:), W, rho);
...
pointActuatorHousingBottom, pointActuatorHousingTop] = Right_Prism_Properties_Without_Inertia(xActuatorHousingMobile, yActuatorHousingMobile, C, rho);
...
pointActuatorHousingGroundedBottom, pointActuatorHousingGroundedTop] = Right_Prism_Properties_Without_Inertia(xActuatorHousingGrounded, yActuatorHousingGrounded, C, rho);
...
pointActuatorHousingFlippedBottom, pointActuatorHousingFlippedTop] = Right_Prism_Properties_Without_Inertia(xActuatorHousingMobileFlipped, yActuatorHousingMobileFlipped, C, rho);
...
pointActuatorHousingGroundedFlippedBottom, pointActuatorHousingGroundedFlippedTop] = Right_Prism_Properties_Without_Inertia(xActuatorHousingGroundedFlipped, yActuatorHousingGroundedFlipped, C, rho);
...
pointActuatorHousingWithoutBladeBottom, pointActuatorHousingWithoutBladeTop] = Right_Prism_Properties_Without_Inertia(xActuatorHousingMobileWithoutBlade, yActuatorHousingMobileWithoutBlade, C, rho);
...
pointActuatorHousingGroundedWithoutBladeBottom, pointActuatorHousingGroundedWithoutBladeTop] = Right_Prism_Properties_Without_Inertia(xActuatorHousingGroundedWithoutBlade, yActuatorHousingGroundedWithoutBlade, C, rho);
...
pointActuatorHousingWithoutBladeFlippedBottom, pointActuatorHousingWithoutBladeFlippedTop] = Right_Prism_Properties_Without_Inertia(xActuatorHousingMobileWithoutBladeFlipped, yActuatorHousingMobileWithoutBladeFlipped, C, rho);
...
pointActuatorHousingGroundedWithoutBladeFlippedBottom, pointActuatorHousingGroundedWithoutBladeFlippedTop] = Right_Prism_Properties_Without_Inertia(xActuatorHousingGroundedWithoutBladeFlipped, yActuatorHousingGroundedWithoutBladeFlipped, C, rho);
...
pointWholeTopBladeBottom, pointWholeTopBladeTop] = Right_Prism_Properties_Without_Inertia(pointWholeTopBladeBottom(1,:), pointWholeTopBladeBottom(2,:), W, rho);
...
pointTopBladeBottom, pointTopBladeTop] = Right_Prism_Properties_Without_Inertia(pointTopBladeBottom(1,:), pointTopBladeBottom(2,:), W, rho);
...
pointBladeHAHBottom, pointBladeHAHTop] = Right_Prism_Properties_Without_Inertia(pointBladeHAHBottom(1,:), pointBladeHAHBottom(2,:), W, rho);
...
pointBladeNHBottom, pointBladeNHTop] = Right_Prism_Properties_Without_Inertia(pointBladeNHBottom(1,:), pointBladeNHBottom(2,:), W, rho);
n1n2n3BladeNH = eye(3);
...
[volumeBigGround, massBigGround, CoMBigGround, IxBigGround, IyBigGround, IzBigGround, IBigGround,...
 pointBigGroundBottom, pointBigGroundTop] = Right_Prism_Properties_Without_Inertia(pointBigGroundBottom(1,:), pointBigGroundBottom(2,:), B/2, rho);
...
pointVoiceCoilBodyBottom, pointVoiceCoilBodyTop] = Right_Prism_Properties_Without_Inertia(xVoiceCoilBody, yVoiceCoilBody, parameterActuatorHollowLength, rho);
...
pointVoiceCoilCapBottom, pointVoiceCoilCapTop] = Right_Prism_Properties_Without_Inertia(xVoiceCoilCap, yVoiceCoilCap, parameterActuatorCapLength, rho);
...
pointVoiceCoilShellBottom, pointVoiceCoilShellTop] = Right_Prism_Properties_Without_Inertia(xVoiceCoilShell, yVoiceCoilShell, parameterActuatorShellLength, rho);
